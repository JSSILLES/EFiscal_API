...
antt.cadastros = {
    ...
    Init: function (options) {
        ...
        $('.btn-voltar-semConfirmacao').on('click', function () {
            self.VoltarSemConfirmacao();
        });

        //salvar formulario
        $('.btn-salvar').on('click', function (evt) {
            self.Salvar();
        });
                ...
                success: function (data) {
                    try {
                        if (data.value === true) {
                            ...
                            if (data.msg === "Registro alterado com sucesso!" || data.voltar === 2)
